...
<template>
      <div class="page" id="page-pool" style="padding:0;overflow:hidden">
        <div id="pool-page-inner" style="display:flex;height:100%;overflow:hidden">
          ...
          <!-- LEFT: List Panel -->
          <div style="flex:1;display:flex;flex-direction:column;overflow:hidden;border-right:1px solid rgba(255,248,235,.06)">
            <!-- Topbar -->
            <div style="padding:14px 20px 10px;border-bottom:1px solid rgba(255,248,235,.05);flex-shrink:0">
              ...
              <div style="display:flex;align-items:center;gap:8px">
                ...
                <select id="pool-sort" onchange="renderPoolTable()" style="font-size:11px;background:rgba(255,248,235,.04);border:1px solid rgba(255,248,235,.07);border-radius:7px;padding:5px 8px;color:#e2e8f0;cursor:pointer">
              ...
              <table style="width:100%;border-collapse:collapse" id="pool-table">
                <thead>
                  <tr style="background:rgba(255,248,235,.02);position:sticky;top:0;z-index:2">
                    <th style="padding:9px 20px;text-align:left;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,248,235,.06)">客户</th>
                    <th style="padding:9px 12px;text-align:left;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,248,235,.06)">来源</th>
                    <th style="padding:9px 12px;text-align:center;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,248,235,.06)">状态</th>
                    <th style="padding:9px 12px;text-align:center;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,248,235,.06)">匹配度</th>
                    <th style="padding:9px 12px;text-align:left;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,248,235,.06)">跟进进度</th>
                    <th style="padding:9px 12px;text-align:left;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,248,235,.06)">最近活跃</th>
                    <th style="padding:9px 12px;text-align:center;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,248,235,.06)">操作</th>
                  </tr>
                </thead>
          ...
          <!-- RIGHT: Detail Panel -->
          <div id="pool-detail-panel" style="width:320px;flex-shrink:0;display:flex;flex-direction:column;overflow:hidden;background:rgba(255,248,235,.01)">
            <div id="pool-detail-content" style="flex:1;overflow-y:auto;padding:20px">
              <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:12px;color:var(--t-muted)">
                <svg viewBox="0 0 24 24" style="width:40px;height:40px;stroke:rgba(255,248,235,.15);fill:none"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
                <div style="font-size:12px;color:rgba(255,248,235,.2)">点击左侧客户查看详情</div>
              </div>
            </div>
          </div>
