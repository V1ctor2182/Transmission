      ...
      <div class="page on" id="page-dashboard">
                ...
                <svg id="night-map-svg" viewBox="0 0 960 280" xmlns="http://www.w3.org/2000/svg" style="position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none">
                  <defs>
                    ...
                    <radialGradient id="seaGrad" cx="50%" cy="50%" r="50%">
                      <stop offset="0%" stop-color="rgba(45,214,198,0.3)"/>
                      <stop offset="100%" stop-color="rgba(45,214,198,0)"/>
                    </radialGradient>
                  ...
                  <g stroke="rgba(45,214,198,0.05)" stroke-width="0.4" fill="none">
                  ...
                  <!-- North America -->
                  <path d="M68,35 L95,28 L130,22 L168,20 L200,24 L228,30 L248,38 L262,50 L268,65 L272,82 L268,100 L258,118 L248,138 L240,158 L232,178 L222,198 L210,218 L198,235 L185,248 L172,258 L158,264 L144,262 L130,255 L116,244 L102,228 L90,210 L80,190 L72,168 L65,146 L60,122 L58,98 L60,75 L64,55Z" fill="#0b1830" stroke="rgba(45,214,198,0.2)" stroke-width="0.7"/>
                  <!-- Central America -->
                  <path d="M172,258 L185,248 L195,255 L200,268 L196,280 L188,285 L178,280 L172,270Z" fill="#0b1830" stroke="rgba(45,214,198,0.15)" stroke-width="0.5"/>
                  <!-- South America -->
                  <path d="M175,288 L195,278 L218,272 L238,278 L250,292 L256,312 L258,335 L255,360 L248,385 L238,408 L224,428 L208,442 L192,448 L176,442 L162,428 L150,408 L142,382 L138,355 L138,328 L142,305 L150,292Z" fill="#0b1830" stroke="rgba(45,214,198,0.12)" stroke-width="0.7"/>
                  <!-- Greenland -->
                  <path d="M268,8 L295,5 L318,8 L330,18 L328,32 L315,40 L298,42 L280,38 L268,28Z" fill="#0a1525" stroke="rgba(45,214,198,0.1)" stroke-width="0.5"/>
                  <!-- UK & Ireland -->
                  ...
                  <!-- Africa -->
                  <path d="M408,118 L440,110 L472,108 L502,112 L525,122 L540,140 L548,162 L550,188 L548,215 L542,242 L532,268 L518,292 L502,315 L485,335 L468,350 L450,358 L432,355 L415,342 L402,322 L392,298 L385,272 L382,245 L382,218 L385,190 L390,162 L396,140Z" fill="#0b1830" stroke="rgba(45,214,198,0.12)" stroke-width="0.7"/>
                  <!-- Madagascar -->
                  <path d="M548,268 L558,262 L565,272 L562,292 L552,298 L544,290 L542,278Z" fill="#0b1830" stroke="rgba(45,214,198,0.1)" stroke-width="0.4"/>
                  <!-- Middle East -->
                  ...
                  <!-- Southeast Asia -->
                  <path d="M658,148 L698,142 L732,145 L758,155 L775,170 L782,190 L778,212 L765,232 L748,248 L728,258 L708,262 L688,255 L670,240 L658,220 L650,198 L648,175Z" fill="#0e1c32" stroke="rgba(45,214,198,0.25)" stroke-width="0.7"/>
                  <!-- Indonesia (Sumatra/Java) -->
                  <path d="M668,258 L705,252 L738,255 L758,265 L762,278 L748,285 L718,282 L688,275 L668,268Z" fill="#0e1c32" stroke="rgba(45,214,198,0.15)" stroke-width="0.5"/>
                  <!-- Philippines -->
                  <path d="M768,168 L782,162 L792,168 L795,182 L788,195 L775,198 L765,192 L762,178Z" fill="#0e1c32" stroke="rgba(45,214,198,0.15)" stroke-width="0.4"/>
                  <!-- Australia -->
                  ...
                  <!-- Singapore -->
                  <circle cx="718" cy="228" r="5" fill="#2dd6c6" filter="url(#hotGlow)">
                    <animate attributeName="r" values="4;12;4" dur="2.5s" repeatCount="indefinite"/>
                    <animate attributeName="opacity" values="1;0.2;1" dur="2.5s" repeatCount="indefinite"/>
                  </circle>
                  <circle cx="718" cy="228" r="4" fill="#5ee6d9"/>
                  ...
                  <!-- Connection arcs -->
                  <g stroke="rgba(45,214,198,0.12)" stroke-width="0.8" fill="none" stroke-dasharray="4,6">
                  ...
                  <!-- Floating labels -->
                  <text x="480" y="490" text-anchor="middle" font-size="9" fill="rgba(45,214,198,0.3)" font-family="Geist,sans-serif" letter-spacing="3">TRADERADAR · GLOBAL OPPORTUNITY MAP</text>
                </svg>
              </div>
            </div>
          </div>
        ...
        <div class="dash-bottom">
          ...
          <div class="mini-panel" style="flex:1.2">
            <div class="mini-title" style="color:#5ee6d9">
