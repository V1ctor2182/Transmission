...
<template>
      <div class="page" id="page-intel" style="padding:0;overflow:hidden">
        <div style="display:flex;flex-direction:column;height:100%;overflow:hidden">
          <!-- Filter Bar -->
          <div style="padding:16px 24px 12px;border-bottom:1px solid rgba(255,255,255,.06);flex-shrink:0;background:rgba(255,255,255,.01)">
            <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap">
              ...
              <!-- Search -->
              <div style="display:flex;align-items:center;gap:6px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);border-radius:8px;padding:5px 12px">
            ...
            <div style="display:flex;align-items:center;gap:8px;margin-top:10px;flex-wrap:wrap">
              ...
              <div style="margin-left:auto;font-size:11px;color:var(--t-muted)">共 <span id="intel-count" style="color:#5ee6d9;font-weight:700">0</span> 条需求</div>
            </div>
          </div>
          <!-- Table -->
            ...
            <table style="width:100%;border-collapse:collapse">
              <thead>
                <tr style="background:rgba(255,255,255,.02);position:sticky;top:0;z-index:2">
                  <th style="padding:10px 24px;text-align:left;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,255,255,.06);white-space:nowrap">国家 / 地区</th>
                  <th style="padding:10px 16px;text-align:left;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,255,255,.06)">采购商</th>
                  <th style="padding:10px 16px;text-align:left;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,255,255,.06)">采购需求</th>
                  <th style="padding:10px 16px;text-align:center;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,255,255,.06);white-space:nowrap">匹配度</th>
                  <th style="padding:10px 16px;text-align:left;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,255,255,.06);white-space:nowrap">建联成功率</th>
                  <th style="padding:10px 16px;text-align:left;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,255,255,.06);white-space:nowrap">线索编号</th>
                  <th style="padding:10px 16px;text-align:left;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,255,255,.06);white-space:nowrap">需求时间</th>
                  <th style="padding:10px 16px;text-align:center;font-size:11px;font-weight:600;color:var(--t-muted);border-bottom:1px solid rgba(255,255,255,.06)">操作</th>
                </tr>
              </thead>
