...
/loop 1min **每轮严格按 /Users/victor/work/创拾觅深/traderadar-vue/docs/loop-procedure.md 执行**(它是本次权威流程,取代旧 Phosphor amber/暗色方向;../DESIGN.md、../CLAUDE.md 里 amber/cyan/暗色的说法全部作废,只读不碰)。流程:读 docs/loop-procedure.md + LOOP-STATE.md + BACKLOG.md → 审计 → 按 backlog 排序取顶。全部改成英文+开头的动画有更多一些有科技感的东西+登录页也是更加酷炫一点+地图就是要有一种交互感 甚至说有一点点游戏感
